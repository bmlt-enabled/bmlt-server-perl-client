...
has _cfg => ( is => 'ro',
              isa => 'bmlt-cli::Configuration',
              default => sub { bmlt-cli::Configuration->new() },
              );
...
has version_info => ( is => 'ro',
                      ...
                      default => sub { {
                          app_name => 'BMLT',
                          app_version => '1.0.0',
                          generator_version => '7.18.0-SNAPSHOT',
...
sub _build_af {
    ...
    return bmlt-cli::ApiFactory->new(%args);
}
...
=item Generator version: 7.18.0-SNAPSHOT
