...
usesub bmlt-cli::Object;

use bmlt-cli::ApiClient;

=head1 Name

    bmlt-cli::ApiFactory - constructs APIs to retrieve bmlt-cli objects

=head1 Synopsis

    package My::Petstore::App;

    use bmlt-cli::ApiFactory;

    my $api_factory = bmlt-cli::ApiFactory->new( ... ); # any args for ApiClient constructor

    # later...
    my $pet_api = $api_factory->get_api('Pet');

    # $pet_api isa bmlt-cli::PetApi
...
my %_apis = map { $_ =~ /^bmlt-cli::(.*)$/; $1 => $_ }
            grep {$_ =~ /Api$/}
            usesub 'bmlt-cli';

=head1 new($api_client)

    create a new bmlt-cli::ApiFactory instance with the given bmlt-cli::ApiClient instance.

=head1 new(%parameters)

    Any parameters are optional, and are passed to and stored on the api_client object.

    See L<bmlt-cli::ApiClient> and L<bmlt-cli::Configuration> for valid parameters
