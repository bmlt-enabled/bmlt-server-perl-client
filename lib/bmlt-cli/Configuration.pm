...
#
package bmlt-cli::Configuration;
...
=head1 Name
        ...
        bmlt-cli::Configuration - holds the configuration for all bmlt-cli Modules
...
default: OpenAPI-Generator/1.0.1/perl
...
sub new {
    ...
    $p{http_timeout} //= 180;
    $p{http_user_agent} //= 'OpenAPI-Generator/1.0.1/perl';
